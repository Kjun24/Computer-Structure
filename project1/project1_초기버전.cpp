...
vector<string> text_reading(string input_str){
    ...
    while (input_str.length()>0){
        if(input_str.find(',')<input_str.length()){
            ...
            cout<<input_str.substr(0, k)<<endl;
        ...
        while (!file_1.eof()){
            ...
            if(text_section &&  str != ".text" && str!=""){
                if (str.find(":")==str.length()-1){ 
                    ...
                    cout<<"it's operation is " << v2[0]<<endl;
                    text_section_size++;
                    cout<<"text section size : " <<text_section_size<<endl;}
        ...
        for(int i=0; i < text_section_length; i++){
            ...
            if (it_I!=Itype_list.end()){
                ...
                if (oper=="lui"){
                    ...
                    cout<<"bne processing"<<endl;
                    string text_label;
                    for (int a =0; a<text_labels.size(); a++){
                        if (text_labels[a] == decode_vec[3]) {text_label = text_labels[a+1]; cout<<text_labels[a+1]<<endl;break;}
                    }
                    cout<<stoi(text_label)<<endl;
            ...
            if (it_J!=Jtype_list.end()){
                ...
                for (int i =0; i<text_labels.size(); i++){
                    if (text_labels[i] == decode_vec[1]) {text_label = text_labels[i+1]; cout<<text_labels[i+1]<<endl;break;}
                }
